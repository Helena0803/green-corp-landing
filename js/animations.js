...
document.querySelector('#budjet').addEventListener('change', function handleSelectChange(event) {
...
function updateScroll() {
  if (window.scrollY > 0) {
   ...
   scroll.classList.add("header__scrolled");
  } else {
    let  scrollRemove = document.querySelector("header");
    scrollRemove.classList.remove("header__scrolled");
  }
